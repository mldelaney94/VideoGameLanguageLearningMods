...
|------|-----|--------------|--------|
| [Shadowrun Returns](https://store.steampowered.com/app/234650/Shadowrun_Returns/) | [BepInEx plugin](shadowrun-returns/mod/) | [Python pipeline](shadowrun-returns/preprocessor/) | In development (chinese) |
